...
export default function RecoveryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-slate-50 to-amber-50 p-6">
      <div className="mx-auto max-w-3xl space-y-6">
        <Card className="border-red-200 bg-white p-6 shadow-lg">
          <div className="flex gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-red-100 text-red-700">
              <ShieldAlert className="h-6 w-6" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-slate-900">Modo recuperación</h1>
        ...
        {!authenticated ? (
          <Card className="p-6">
            ...
            <form onSubmit={handleRecoveryLogin} className="space-y-3 max-w-md">
              <input
                type="email"
                  ...
                  <tbody>
                    {historial.map((h) => (
                      <tr key={h.id} className="border-t">
                        <td className="px-3 py-2 text-xs">{formatDt(h.iniciado_en)}</td>
